...
rule graftm_sift:
	...
	shell:
		...
		"ln -s $PWD/02-graftm_sifted/{wildcards.sample}/{wildcards.sample}*/forward/{wildcards.sample}*_hits.fa {R1hits} ; "
		"ln -s $PWD/02-graftm_sifted/{wildcards.sample}/{wildcards.sample}*/reverse/{wildcards.sample}*_hits.fa {R2hits} ; "
		"ln -s $PWD/02-graftm_sifted/{wildcards.sample}/{wildcards.sample}*/forward/{wildcards.sample}*hmmout.txt {R1hmmout} ; "
		"ln -s $PWD/02-graftm_sifted/{wildcards.sample}/{wildcards.sample}*/reverse/{wildcards.sample}*hmmout.txt {R2hmmout}"
