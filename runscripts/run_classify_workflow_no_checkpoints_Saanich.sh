...
snakemake --snakefile Snakefile-classify.smk  --configfile config/Saanich_inlet/config-Saanich-master.yaml --use-conda --cores $cores --until make_tax_matchVSmismatch_barplots
