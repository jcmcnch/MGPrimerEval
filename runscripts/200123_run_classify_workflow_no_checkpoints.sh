...
snakemake --snakefile Snakefile-classify.smk  --configfile config/Malaspina/config-Malaspina.yaml --use-conda --cores $cores --until make_tax_matchVSmismatch_barplots
