...
rule phyloFlash_sift:
	...
	shell:
		...
		phyloFlash.pl -readlimit 1000000 -lib {wildcards.sample} -read1 ../../{input.R1clean} -read2 ../../{input.R2clean} -dbhome /home/db/phyloFlash/132 -readlength {readLength} -id 50 -CPUs {threads} -log -skip_spades -nozip ;
